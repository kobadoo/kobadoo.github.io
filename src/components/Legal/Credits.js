...
const Credits = () => {
    ...
    <div className={classes.Legal}>
        ...
        <ul>
            ...
            <li>Poker card images made by <a href="https://code.google.com/archive/p/vector-playing-cards/" title="vector-playing-cards" target="_new">vector-playing-cards</a></li>            
