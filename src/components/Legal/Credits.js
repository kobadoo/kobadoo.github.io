...
const Credits = () => {
    ...
    <div className={classes.Legal}>
        ...
        <ul>
            ...
            <li>Text-to-speech by <a href="https://soundoftext.com/" title="Sound of Text" target="_new">Sound of Text</a></li>
            <li>Sound effects by <a href="https://pixabay.com/" title="Pixabay" target="_new">Pixabay</a></li>
