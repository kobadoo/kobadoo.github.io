...
import { faBlogger, faFacebook, faXTwitter, faYoutube } from '@fortawesome/free-brands-svg-icons';
...
const footer = () => (
    <div className={classes.Footer}>
        ...
        <div className={classes.FooterItem}><a href="https://x.com/kobadooApp" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faXTwitter} size="2x" /></a></div>
